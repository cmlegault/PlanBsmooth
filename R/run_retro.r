...
RunRetro <- function(dat,
  ...
  if(saveretroplot) ggsave(file.path(od, paste0(nameplots, "retro_plot_biomass.png")), retro_plot_biomass)
  ...
  if(saveretroplot) ggsave(file.path(od, paste0(nameplots, "retro_plot_multiplier.png")), retro_plot_multiplier)
